      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="bg-white rounded-3xl shadow-2xl p-10 max-w-4xl mx-auto">
          ...
          <form className="grid grid-cols-1 md:grid-cols-2 gap-6" onSubmit={handleSubmit}>
            ...
            {/* INPUTS WITH GREY BACKGROUND + BLACK PLACEHOLDER */}
            <input
              type="text"
              name="name"
              ...
              className="w-full p-4 rounded-xl bg-gray-100 border border-gray-300 placeholder-black focus:ring-2 focus:ring-[#0B7A75] outline-none"
              required
            />
            ...
            <textarea
              ...
              onChange={handleChange}
              className="w-full p-4 rounded-xl bg-gray-100 border border-gray-300 placeholder-black focus:ring-2 focus:ring-[#0B7A75] outline-none md:col-span-2"
            ></textarea>

            <button
              type="submit"
              className="bg-gradient-to-r from-[#0B7A75] via-[#083f41] to-black text-white py-4 px-8 rounded-xl font-semibold shadow-xl hover:scale-105 transition transform md:col-span-2"
            >
              Book Appointment
            </button>
