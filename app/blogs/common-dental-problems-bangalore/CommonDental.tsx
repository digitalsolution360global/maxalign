...
export default function CommonDentalBlog() {
  ...
  const faqs = [
  {
    ...
    answer: "Common dental problems are listed below: tooth decay gum disease tooth sensitivity To combat them effectively, you need regular check-ups at a trusted family dental clinic in Bangalar, and that is “MaxAlign”."
  },
  {
