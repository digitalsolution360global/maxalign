    ...
    },
{
    ...
    {
      url: `${baseUrl}/blogs/best-cosmetic-dentist-bangalore`,
      lastModified: new Date(),
      changeFrequency: 'monthly',
      priority: 0.7,
    },
    ...
    {
      url: `${baseUrl}/blogs/dental-implants-vs-bridges-best-option-bangalore-maxalign`,
      lastModified: new Date(),
      changeFrequency: 'monthly',
      priority: 0.7,
    },
    ...
    {
      url: `${baseUrl}/blogs/dental-technology-bangalore-ai-laser-treatments`,
      lastModified: new Date(),
      changeFrequency: 'monthly',
      priority: 0.7,
    },
